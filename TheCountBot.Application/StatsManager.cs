...
namespace TheCountBot
{
    internal class StatsManager : IStatsManager
    {
        ...
        private async Task SendMessageAsync(string message, ParseMode parseMode)
        {
            await _botClient.SendTextMessageAsync(_settings.MetaCountingChatId, message, parseMode: parseMode);
        }
